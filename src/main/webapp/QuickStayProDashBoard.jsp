		...
		<div class="row">
			<div class="col-md-4">
				<div class="testimonial">
					...
					<p>"Quick Stay Pro made managing our hotel a breeze!"</p>
				</div>
			</div>
			<div class="col-md-4">
				<div class="testimonial">
					<img src="testimonial-2.jpg" alt="Customer 2">
					<p>"An excellent tool for hotel owners and managers."</p>
				</div>
			</div>
			<div class="col-md-4">
				<div class="testimonial">
					<img src="testimonial-3.jpg" alt="Customer 3">
					<p>"Efficient and user-friendly. Highly recommended!"</p>
				</div>
			</div>
		</div>
	</div> -->
